...
t_another_film_table = Table(
    'another_film_table', metadata,
...
t_filmy_duniya_new = Table(
    'filmy_duniya_new', metadata,
    Column('film_id', Integer),
    Column('title', String(255)),
    Column('description', Text),
    Column('release_year', Integer),
    Column('language_id', SmallInteger),
    Column('rental_duration', SmallInteger),
    Column('rental_rate', Numeric(4, 2)),
    Column('length', SmallInteger),
    Column('replacement_cost', Numeric(5, 2)),
    Column('rating', Enum('G', 'PG', 'PG-13', 'R', 'NC-17', name='mpaa_rating')),
    Column('last_update', DateTime),
    Column('special_features', ARRAY(Text())),
